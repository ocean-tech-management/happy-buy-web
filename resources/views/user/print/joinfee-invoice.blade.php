                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="left strong">Joining Fee</td>
                            <td class="left"> - </td>
                            <td class="right">RM {{ number_format($invoice->fee,2) }}</td>
                            <td class="center">{{ '1' }}</td>
                            <td class="right">RM {{ number_format($invoice->fee,2) }}</td>
                        </tr>
...
{{--                            </td>--}}
{{--                            <td class="right">RM {{ number_format($invoice->deposit, 2) }}</td>--}}
{{--                        </tr>--}}
                        ...
                        <tr>
                            ...
                            <td class="right">
                                <strong class="text-dark">RM {{ number_format($invoice->fee, 2) }}</strong>
                            </td>
                        </tr>
                        </tbody>
                    </table>
