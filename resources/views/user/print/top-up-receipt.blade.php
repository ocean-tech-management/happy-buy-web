            ...
            <div class="table-responsive-sm">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td class="left strong">{{ $receipt->point_package->name }}</td>
                        <td class="left">Point Package with value {{ $receipt->point }} PV</td>
                        <td class="right">RM {{ number_format($receipt->price,2) }}</td>
                        <td class="center">1</td>
                        <td class="right">RM {{ number_format($receipt->price,2) }}</td>
                    </tr>
                ...
                <div class="col-lg-4 col-sm-5 ml-auto">
                    <table class="table table-clear">
                        ...
                        <tr>
                            ...
                            <td class="right">
                                <strong class="text-dark">RM {{ number_format($receipt->price,2) }}</strong>
                            </td>
                        </tr>
                        </tbody>
                    </table>
