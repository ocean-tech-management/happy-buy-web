        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="row col-12  justify-content-center" style="max-width: 935px;">
                    ...
                    <form method="post" action="{{route('user.upgrade-account-executive')}}" id="register-form"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 margin-10px-bottom">
                                ...
                                <input class="small-input border-all border-radius-5px" type="text" name="name"
                                       placeholder="{{ __('user-portal.enter_your' , ['title'=> __('user-portal.full_name')]) }}" value="{{ $user->name}}" required disabled>
                            </div>
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="text-extra-dark-gray alt-font margin-15px-bottom" for="birthday">{{ __('user-portal.birthday') }} <span
                                        class="text-radical-red">*</span></label>
                                <input class="small-input border-all border-radius-5px" type="date" name="birthday" value="{{ $user->date_of_birth }}" required disabled>
                            </div>
                            <div class="col-md-6 margin-10px-bottom">
                                ...
                                <select name="gender" id="gender" class="small-input border-all border-radius-5px" disabled>
                                    ...
                                    <option value="1" {{ $user->gender == 1 ? "selected" : "" }}>{{ __('user-portal.male') }}</option>
                                    <option value="2" {{ $user->gender == 2 ? "selected" : "" }}>{{ __('user-portal.female') }}</option>
                                </select>
                            </div>
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="text-extra-dark-gray alt-font margin-15px-bottom">{{ __('user-portal.identity_card_passport_number') }} <span
                                        class="text-radical-red">*</span></label>
                                <select name="identity_type" id="identity_type" class="small-input border-all border-radius-5px" required disabled>
                                    <option value="">{{ __('user-portal.select_' , ['title'=> __('user-portal.identity_type')]) }}</option>
                                    <option value="1" {{ $user->identity_type == 1 ? "selected" : "" }}>{{ App\Models\User::IDENTITY_TYPE_SELECT[1] }}</option>
                                    <option value="2" {{ $user->identity_type == 2 ? "selected" : "" }}>{{ App\Models\User::IDENTITY_TYPE_SELECT[2] }}</option>
                                    <option value="2" {{ $user->identity_type == 3 ? "selected" : "" }}>{{ App\Models\User::IDENTITY_TYPE_SELECT[3] }}</option>
                                </select>
                                <input class="small-input border-all border-radius-5px" type="text" name="identity_no"
                                       ...
                                       value="{{$user->identity_no }}" required disabled>
                            </div>
                            {{--                            <div class="col-md-6 margin-10px-bottom">--}}
                            {{--                            </div>--}}
{{--                            <div class="col-md-6 margin-10px-bottom">--}}
...
{{--                            </div>--}}
                            ...
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="text-extra-medium text-extra-dark-gray  alt-font margin-15px-bottom">{{ __('user-portal.bank') }} <span
                            ...
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="text-extra-medium text-extra-dark-gray  alt-font margin-15px-bottom">{{__('user-portal.bank_account')}}<span
                                        class="required-error text-radical-red">*</span></label>
                            ...
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="text-extra-medium text-extra-dark-gray  alt-font margin-15px-bottom">{{__('user-portal.beneficiary_name')}}<span
                                        class="required-error text-radical-red">*</span></label>
                            ...
                            <div class="col-md-6 margin-10px-bottom">
                                ...
                                <input class="small-input border-all border-radius-5px" type="text" name="ref_code"
                                       ...
                                       value="{{ $direct_upline->personal_code }}" required disabled>
                            </div>
                            {{--                            <div class="col-md-6 margin-10px-bottom">--}}
                            ...
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="text-extra-dark-gray alt-font margin-15px-bottom">{{ __('user-portal.payment_date') }} <span
                                        class="text-radical-red">*</span></label>
                                <input class="small-input border-all border-radius-5px" type="date" name="payment_date" value="{{ old('payment_date') }}" required>
                            </div>
                            <div class="col-md-6 margin-10px-bottom">
