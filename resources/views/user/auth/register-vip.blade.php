        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="row col-12  justify-content-center" style="max-width: 935px;">
                    <h6 class="title-small alt-font font-weight-300 dark-gold">{{ __('user-portal.vip_user_registration') }}</h6>

                    <form method="post" action="{{route('user.registerVip')}}" id="register-form"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 margin-5px-bottom">
                                ...
                                <div class="col-md-12 margin-5px-bottom">
                                    <span class="text-medium-gray alt-font text-small "> {{ __('user-portal.voucher_remains') }}: {{ $cash_voucher_count }} </span>
                            </div>
...
{{--                            </div>--}}
                            ...
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="text-extra-dark-gray alt-font margin-15px-bottom">{{ __('user-portal.enter_reference_code') }} <span
                                        class="text-radical-red">*</span></label>
                                <input class="small-input border-all border-radius-5px bg-light-gray" type="text"
                                       placeholder="{{ __('user-portal.enter_' , ['title'=> __('user-portal.enter_reference_code')]) }}"
                                       value="{{ Auth::user()->personal_code }}" disabled>
                                <input type="hidden" name="ref_code" value="{{ Auth::user()->personal_code }}">
                            </div>
                            {{--                            <div class="col-md-6 margin-10px-bottom">--}}
