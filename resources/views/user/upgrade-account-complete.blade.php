        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="row col-12  justify-content-center" style="max-width: 935px;">
                    <h6 class="title-small alt-font font-weight-300 dark-gold margin-50px-bottom">{{__('user-portal.upgrade_account_success')}}</h6>
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-6 margin-50px-bottom row justify-content-center mx-auto">
                                 <span class="text-extra-dark-gray text-extra-large alt-font" style="text-align: center">
                                    {{__('user-portal.your_downline_account_has_been_upgraded')}}
                                </span>
                        </div>
                        <div class="col-md-12 margin-50px-bottom row justify-content-center mx-auto">
                            <table>
                                <tr>
                                    <td class="text-right alt-font text-extra-large">{{ __('user-portal.user') }}</td>
                                    <td class="alt-font text-extra-large text-black">{{ $transactionTopUp->user->name}}</td>
                                </tr>
                                <tr>
                                    <td class="text-right alt-font text-extra-large">{{ __('user-portal.date') }}</td>
                                    <td class="alt-font text-extra-large text-black">{{ $transactionTopUp->updated_at }}</td>
                                </tr>
{{--                                <tr>--}}
{{--                                    <td class="text-right alt-font text-extra-large">{{ __('user-portal.balance_after_top_up') }}</td>--}}
{{--                                    <td class="alt-font text-extra-large text-black">{{ number_format($return_data['balance_after']) }}</td>--}}
{{--                                </tr>--}}
                            </table>
