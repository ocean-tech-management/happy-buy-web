...
@section('content')
    ...
    <section class="wow animate__fadeIn">
        <form action="{{ route('user.cart.checkout') }}" method="post"
            ...
            <input type="text" value="{{$selected_user_id}}" name="selected_user_id"/>
            <div class="row">
                            ...
                            <tr class="address">
                                ...
                                <td class="" colspan="2">
                                    ...
                                    @foreach( $addressBooks as $addressBook)
                                        <div class=" d-none {{ ($addressBook->set_default == 1) ? "d-block": "" }} show-address text-left text-md-right"
                                             id="show-address-{{$addressBook->id}}"
                                                ...
                                                <select class="form-control" id="my-adddresses" autocomplete="off">
                                                    ...
                                                    @foreach( $addressBooks as $addressBook)
                                                        <option addressName="{{ $addressBook->name }}"
                                                                ...
                                                                defaultAddress="{{ $addressBook->set_default }}"
                                                        >
