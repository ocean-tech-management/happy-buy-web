...
@section('content')
    ...
    <div class="row" style='margin-bottom: 1rem;'>
        <form id="form" action="{{ route('admin.dashboard.getdate') }}" method="GET" style="display: inline-block;">
    ...
    <div class="card">
        ...
        <livewire:admin.dashboard :order="$order" :startDate="$start" :endDate="$end"/>
