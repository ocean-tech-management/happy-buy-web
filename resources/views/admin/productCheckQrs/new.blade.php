...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-10">
            <div class="card">
                <div class="card-body">
                    <form method="get" action="{{ route('admin.product-check-qrs.new') }}">
                        <div class="row">
                            <div class="form-group col-6">
                                <label class="required" for="code">{{ trans('cruds.productCheckQr.fields.code') }}</label>
                                <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" type="text" name="code" id="code" value="{{ old('code', '') }}" autofocus required>
