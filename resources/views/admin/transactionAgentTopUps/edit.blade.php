...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.transactionAgentTopUp.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.transaction-agent-top-ups.update", [$transactionAgentTopUp->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="transaction">{{ trans('cruds.transactionAgentTopUp.fields.transaction') }}</label>
                <input class="form-control {{ $errors->has('transaction') ? 'is-invalid' : '' }}" type="text" name="transaction" id="transaction" value="{{ old('transaction', $transactionAgentTopUp->transaction) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id">
                    @foreach($users as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $transactionAgentTopUp->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('merchant') ? 'is-invalid' : '' }}" name="merchant_id" id="merchant_id">
                    @foreach($merchants as $id => $entry)
                        <option value="{{ $id }}" {{ (old('merchant_id') ? old('merchant_id') : $transactionAgentTopUp->merchant->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="text" name="amount" id="amount" value="{{ old('amount', $transactionAgentTopUp->amount) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('merchant_pre_balance') ? 'is-invalid' : '' }}" type="text" name="merchant_pre_balance" id="merchant_pre_balance" value="{{ old('merchant_pre_balance', $transactionAgentTopUp->merchant_pre_balance) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('merchant_post_balance') ? 'is-invalid' : '' }}" type="text" name="merchant_post_balance" id="merchant_post_balance" value="{{ old('merchant_post_balance', $transactionAgentTopUp->merchant_post_balance) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_pre_balance') ? 'is-invalid' : '' }}" type="text" name="user_pre_balance" id="user_pre_balance" value="{{ old('user_pre_balance', $transactionAgentTopUp->user_pre_balance) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_post_balance') ? 'is-invalid' : '' }}" type="text" name="user_post_balance" id="user_post_balance" value="{{ old('user_post_balance', $transactionAgentTopUp->user_post_balance) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Models\TransactionAgentTopUp::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $transactionAgentTopUp->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('approved_at') ? 'is-invalid' : '' }}" type="text" name="approved_at" id="approved_at" value="{{ old('approved_at', $transactionAgentTopUp->approved_at) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('rejected_at') ? 'is-invalid' : '' }}" type="text" name="rejected_at" id="rejected_at" value="{{ old('rejected_at', $transactionAgentTopUp->rejected_at) }}">
