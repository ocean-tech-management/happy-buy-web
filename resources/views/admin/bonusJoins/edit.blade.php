...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.bonusJoin.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bonus-joins.update", [$bonusJoin->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_upline_bonus') ? 'is-invalid' : '' }}" type="number" name="first_upline_bonus" id="first_upline_bonus" value="{{ old('first_upline_bonus', $bonusJoin->first_upline_bonus) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('second_upline_bonus') ? 'is-invalid' : '' }}" type="number" name="second_upline_bonus" id="second_upline_bonus" value="{{ old('second_upline_bonus', $bonusJoin->second_upline_bonus) }}" step="0.01" required>
