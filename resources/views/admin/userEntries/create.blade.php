...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.userEntry.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.user-entries.store") }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('deposit') ? 'is-invalid' : '' }}" type="text" name="deposit" id="deposit" value="{{ old('deposit', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('fee') ? 'is-invalid' : '' }}" type="text" name="fee" id="fee" value="{{ old('fee', '') }}" required>
                    @if($errors->has('fee'))
                        <div class="invalid-feedback">
                            {{ $errors->first('fee') }}
                        </div>
