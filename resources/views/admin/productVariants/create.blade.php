...
@section('content')
    ...
    <form method="POST" action="{{ route("admin.product-variants.store") }}" enctype="multipart/form-data">
        @csrf
        @if (session('error'))
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group col-xl-4 col-sm-4">
                                        ...
                                        @endif
                                        <span class="help-block">{{ trans('cruds.productVariant.fields.type_helper') }}</span>
                                    </div>
                                    <div class="form-group col-xl-4 col-sm-4">
                            ...
                            <div class="row">
                                    <div class="form-group col-xl-4 col-sm-4">
                                        ...
                                        <input class="form-control {{ $errors->has('sales_price') ? 'is-invalid' : '' }}" type="text" name="sales_price" id="sales_price" value="{{ old('sales_price', '') }}" required>
                                    ...
                                    <div class="form-group col-xl-4 col-sm-4">
                                        ...
                                        <input class="form-control {{ $errors->has('merchant_president_price') ? 'is-invalid' : '' }}" type="text" name="merchant_president_price" id="merchant_president_price" value="{{ old('merchant_president_price', '') }}" required>
                                    ...
                                    <div class="form-group col-xl-4 col-sm-4">
                                        ...
                                        <input class="form-control {{ $errors->has('agent_director_price') ? 'is-invalid' : '' }}" type="text" name="agent_director_price" id="agent_director_price" value="{{ old('agent_director_price', '') }}" required>
                                    ...
                                    <div class="form-group col-xl-4 col-sm-4">
                                        ...
                                        <input class="form-control {{ $errors->has('agent_executive_price') ? 'is-invalid' : '' }}" type="text" name="agent_executive_price" id="agent_executive_price" value="{{ old('agent_executive_price', '') }}" required>
                                    ...
                                    <div class="form-group col-xl-4 col-sm-4">
                                        ...
                                        <input class="form-control {{ $errors->has('vip_redeem_pv') ? 'is-invalid' : '' }}" type="text" name="vip_redeem_pv" id="vip_redeem_pv" value="{{ old('vip_redeem_pv', '') }}" required>
                                    ...
                                    <div class="form-group col-xl-4 col-sm-4">
                                        ...
                                        <input class="form-control {{ $errors->has('price_add_on') ? 'is-invalid' : '' }}" type="text" name="price_add_on" id="price_add_on" value="{{ old('price_add_on', '') }}" required>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input class="form-control {{ $errors->has('qr_quantity') ? 'is-invalid' : '' }}" type="number" name="qr_quantity" id="qr_quantity" value="{{ old('qr_quantity', '1') }}" step="1" required>
    ...
    <div class="row">
        ...
        <div class="col-10">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3">{{ trans('cruds.productVariant.fields.available_variants') }}</h4>
                    <table class=" table table-bordered table-striped table-hover">
                        <th>
                            {{ trans('cruds.productVariant.fields.color') }}
                        </th>
                        <th>
                            {{ trans('cruds.productVariant.fields.type') }}
                        </th>
                        <th>
                        ...
                        <th>
                            {{ trans('cruds.productVariant.fields.vip_price') }}
                        </th>
                        <th>
                        ...
                        @empty
                            <tr><td colspan="10" style="text-align: center">{{ trans('global.no_entries_in_table') }}</td></tr>
                        @endforelse
                    </table>
                </div>
            </div>
