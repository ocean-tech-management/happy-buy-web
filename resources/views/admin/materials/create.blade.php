    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.materials.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('file_title_1') ? 'is-invalid' : '' }}" type="text" name="file_title_1" id="file_title_1" value="{{ old('file_title_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('file_title_2') ? 'is-invalid' : '' }}" type="text" name="file_title_2" id="file_title_2" value="{{ old('file_title_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('file_title_3') ? 'is-invalid' : '' }}" type="text" name="file_title_3" id="file_title_3" value="{{ old('file_title_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('file_title_4') ? 'is-invalid' : '' }}" type="text" name="file_title_4" id="file_title_4" value="{{ old('file_title_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('file_title_5') ? 'is-invalid' : '' }}" type="text" name="file_title_5" id="file_title_5" value="{{ old('file_title_5', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('publish_year') ? 'is-invalid' : '' }}" type="number" name="publish_year" id="publish_year" value="{{ old('publish_year', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('publish_month') ? 'is-invalid' : '' }}" type="number" name="publish_month" id="publish_month" value="{{ old('publish_month', '') }}" step="1">
