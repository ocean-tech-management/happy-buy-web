        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.points.update", [$point->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('point_balance') ? 'is-invalid' : '' }}" type="text" name="point_balance" id="point_balance" value="{{ old('point_balance', $point->point_balance) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('point_manager_balance') ? 'is-invalid' : '' }}" type="text" name="point_manager_balance" id="point_manager_balance" value="{{ old('point_manager_balance', $point->point_manager_balance) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('point_executive_balance') ? 'is-invalid' : '' }}" type="text" name="point_executive_balance" id="point_executive_balance" value="{{ old('point_executive_balance', $point->point_executive_balance) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('point_bonus_balance') ? 'is-invalid' : '' }}" type="text" name="point_bonus_balance" id="point_bonus_balance" value="{{ old('point_bonus_balance', $point->point_bonus_balance) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('voucher_balance') ? 'is-invalid' : '' }}" type="text" name="voucher_balance" id="voucher_balance" value="{{ old('voucher_balance', $point->voucher_balance) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('shipping_balance') ? 'is-invalid' : '' }}" type="text" name="shipping_balance" id="shipping_balance" value="{{ old('shipping_balance', $point->shipping_balance) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('cash_voucher_balance') ? 'is-invalid' : '' }}" type="text" name="cash_voucher_balance" id="cash_voucher_balance" value="{{ old('cash_voucher_balance', $point->cash_voucher_balance) }}">
                    @if($errors->has('cash_voucher_balance'))
                        <div class="invalid-feedback">
                            {{ $errors->first('cash_voucher_balance') }}
                        </div>
                    @endif
                    <span class="help-block">{{ trans('cruds.point.fields.cash_voucher_balance_helper') }}</span>
                </div>
                <div class="form-group">
                    <label for="pv_balance">{{ trans('cruds.point.fields.pv_balance') }}</label>
                    <input class="form-control {{ $errors->has('pv_balance') ? 'is-invalid' : '' }}" type="text" name="pv_balance" id="pv_balance" value="{{ old('pv_balance', $point->pv_balance) }}">
