    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.order-items.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_name_en') ? 'is-invalid' : '' }}" type="text" name="product_name_en" id="product_name_en" value="{{ old('product_name_en', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_name_zh') ? 'is-invalid' : '' }}" type="text" name="product_name_zh" id="product_name_zh" value="{{ old('product_name_zh', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('product_desc_en') ? 'is-invalid' : '' }}" name="product_desc_en" id="product_desc_en">{{ old('product_desc_en') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_desc_zh') ? 'is-invalid' : '' }}" type="text" name="product_desc_zh" id="product_desc_zh" value="{{ old('product_desc_zh', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_color') ? 'is-invalid' : '' }}" type="text" name="product_color" id="product_color" value="{{ old('product_color', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_size') ? 'is-invalid' : '' }}" type="text" name="product_size" id="product_size" value="{{ old('product_size', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('merchant_president_price') ? 'is-invalid' : '' }}" type="text" name="merchant_president_price" id="merchant_president_price" value="{{ old('merchant_president_price', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agent_director_price') ? 'is-invalid' : '' }}" type="text" name="agent_director_price" id="agent_director_price" value="{{ old('agent_director_price', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agent_executive_price') ? 'is-invalid' : '' }}" type="text" name="agent_executive_price" id="agent_executive_price" value="{{ old('agent_executive_price', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_add_on') ? 'is-invalid' : '' }}" type="text" name="price_add_on" id="price_add_on" value="{{ old('price_add_on', '') }}">
