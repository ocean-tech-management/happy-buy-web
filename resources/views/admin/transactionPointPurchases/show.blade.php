                        ...
                        <div class="col-6">
                            <table width="100%" cellspacing="5" cellpadding="5" class="mt-2" style="text-align: right">
                                ...
                                <tr>
                                    ...
                                    <td width="10%">
                                       RM <strong>{{ number_format($transactionPointPurchase->price) }} </strong>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        @can('transaction_point_purchase_to_verify')
                            @if($transactionPointPurchase->status == 2)
                                <div class="border-top d-flex align-items-center pt-3">
                                    ...
                                    <div class="ms-auto">
                                        <form action="{{ route('admin.transaction-point-purchases.to-verify') }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <input type="hidden" name="id" value="{{ $transactionPointPurchase->id }}">
                    ...
                    @if($transactionPointPurchase->status == 1)
                        ...
                        <div class="p-3">
                            @if($transactionPointPurchase->status == 1)
                                ...
                                &nbsp;
                                <span>{{ trans('cruds.transactionPointPurchase.fields.order_was_rejected_by', ['value' => $transactionPointPurchase->admin->name]) }}</span>
