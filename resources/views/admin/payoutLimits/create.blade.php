...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.payoutLimit.title_singular') }}
    </div>
    ...
    <div class="card-body">
        ...
        @endif
        <form method="POST" action="{{ route("admin.payout-limits.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_amount') ? 'is-invalid' : '' }}" type="number" name="max_amount" id="max_amount" value="{{ old('max_amount', '') }}" step="0.01" required>
