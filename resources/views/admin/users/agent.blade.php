...
@can('user_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.users.agents.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.user.fields.agent') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.user.fields.agent') }} {{ trans('global.list') }}
    </div>
