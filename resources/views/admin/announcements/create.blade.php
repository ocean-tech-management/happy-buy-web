...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.announcements.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="desc">{{ trans('cruds.announcement.fields.desc') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.announcement.fields.desc_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="roles">{{ trans('cruds.announcement.fields.role') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.announcement.fields.role_helper') }}</span>
            </div>
            <div class="form-group">
