                    ...
                    <div class="col-md-6">
                        <table class="table table-responsive table-bordered table-hover">
                            <tbody>
                                ...
                                <tr>
                                    <th>{{ trans('cruds.report.fields.transaction_period') }}</th>
                                    <td field-key="transaction_period">{{\Carbon\Carbon::parse($all[0]->transaction_date)->format('Y-m-d')}} - {{\Carbon\Carbon::parse($all[count($all)-1]->transaction_date)->format('Y-m-d')}}</td>
                                </tr>
                                @endif
                            </tbody>
                        </table>
