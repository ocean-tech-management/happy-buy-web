...
{{--    @endcan--}}
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.report.fields.shipping_credit_balance') }} {{ trans('global.list') }}
        </div>

        <form action="{{ route('admin.reports.shipping-credit-balance.export') }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
    ...
    <script>
        $(function () {
            ...
            let dtOverrideGlobals = {
                ...
                paging: false,
                ajax: {
                    url: "{{ route('admin.reports.shipping-credit-balance') }}",
                    data: function (d) {
                        d.user = $('#user').val();
