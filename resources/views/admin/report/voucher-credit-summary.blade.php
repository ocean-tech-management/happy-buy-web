...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.report.fields.voucher_credit') }} {{ trans('global.list') }}
        </div>

        <form action="{{ route('admin.reports.voucher-credit-summary.export') }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
    ...
    <script>
        $(function () {
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: {
                    url: "{{ route('admin.reports.voucher-credit-summary') }}",
                    data: function (d) {
                        d.user = $('#user').val();
