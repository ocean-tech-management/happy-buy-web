    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <form action="{{ route('admin.reports.stock-credit-balance-topup-agent-detail.export') }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
