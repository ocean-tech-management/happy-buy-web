...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.report.fields.stock_credit_balance_topup_millionaire') }} {{ trans('global.list') }}
        </div>

        <form action="{{ route('admin.reports.stock-credit-balance-millionaire-topup.export') }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
    ...
    <script>
        $(function () {
            ...
            let dtOverrideGlobals = {
                ...
                paging: false,
                ajax: {
                    url: "{{ route('admin.reports.stock-credit-balance-millionaire-topup')}}",
                    data: function (d) {
                        d.user = $('#user').val();
