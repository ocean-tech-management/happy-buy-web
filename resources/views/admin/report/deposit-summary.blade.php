...
{{--    @endcan--}}
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.report.fields.deposit_summary') }} {{ trans('global.list') }}
        </div>

        <form action="{{ route('admin.reports.deposit-summary.export') }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
    ...
    <script>
        $(function () {
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: {
                    url: "{{ route('admin.reports.deposit-summary') }}",
                    data: function (d) {
                        d.user = $('#user').val();
