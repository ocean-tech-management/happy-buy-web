...
{{--    @endcan--}}
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.report.fields.shipping_credit') }} {{ trans('global.list') }}
        </div>

        <form action="{{ route('admin.reports.shipping-credit-summary.export') }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
    ...
    <script>
        $(function () {
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: {
                    url: "{{ route('admin.reports.shipping-credit-summary') }}",
                    data: function (d) {
                        d.user = $('#user').val();
                ...
                columns: [
                    { data: 'id', name: 'report_shipping_credits.id' , visible: false},
