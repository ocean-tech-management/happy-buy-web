...
{{--    @endcan--}}
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.report.fields.stock_credit_summary') }} {{ trans('global.list') }}
        </div>

        <form action="{{ route('admin.reports.stock-credit-summary.export') }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
    ...
    <script>
        $(function () {
            ...
            let dtOverrideGlobals = {
                ...
                ajax: {
                    url: 
                    @if(Route::is("admin.reports.stock-credit-summary")) "{{ route('admin.reports.stock-credit-summary') }}"
                    @elseif(Route::is("admin.reports.stock-credit-summary-millionaire")) "{{ route('admin.reports.stock-credit-summary-millionaire') }}"
                    @endif,
                    data: function (d) {
                        d.user = $('#user').val();
                ...
                columns: [
                    { data: 'id', name: 'report_stock_credits.id' , visible: false},
