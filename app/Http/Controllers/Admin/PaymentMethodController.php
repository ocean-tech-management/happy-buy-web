    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('actions', function ($row) {
                ...
                $statusChangeGate = 'payment_method_status_change';
                $crudRoutePart = 'payment-methods';

                return view('partials.datatablesActions_PaymentMethod', compact(
                'viewGate',
                'editGate',
                'deleteGate',
                'statusChangeGate',
            ...
            $table->editColumn('status', function ($row) {
                return $row->status ? PaymentMethod::STATUS_SELECT[$row->status] : '';
            });
