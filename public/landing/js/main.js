!function (t) {
    "use strict";
    var a, o, i = 991, n = 991, r = 0, s = 0, l = 0, d = [], c = [], p = "", h = !1;
    ...
    (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (h = !0), /iPhone|iPad|iPod/i.test(navigator.userAgent) && !0, t(".image-back-offset-shadow, .vertical-counter, .counter, .progress-bar, .pie-chart-style-01, .pie-chart-style-02").each(function () {
        ...
        if (a > i) {
            ...
            var n = t(this).position().left, r = t(this).outerWidth(), s = t(".navbar-collapse").offset().left,
                l = o.outerWidth(), d = n + r / 2 - l / 2, c = a - s;
    ...
    if (t(document).on("click", ".qty-plus", function (e) {
        ...
        var e = "IGQVJVSXJPdUZACRW9GeVpHdDdORUgyQ0tSMmtCMF9TdnhUaFBoQjdaRlVFZAm5PQ3l0WThoTWgzbU5kbVF3TkE0X1FYcmZAsVG1kbE9ZASEY4TVlpdmRrV3Rtc0h3M0pfZADdXeV85UWdDRjRTWjV5ZA0FRSgZDZD",
            a = t(this), o = (e = a.attr("data-token") || e, a.attr("data-total") || "6"),
            i = a.attr("data-slider-options"), n = a.html(), r = "";
        null != i && a.html(""), t.ajax({
            ...
            success: function (e) {
                for (var s in r += a.find(".grid-item").length > 0 ? '<li class="grid-sizer"></li>' : "", e.data) if (s < parseInt(o) && "IMAGE" == e.data[s].media_type) {
                    var l = e.data[s].permalink || "", c = e.data[s].media_url || "", p = e.data[s].like_count || "",
                        u = e.data[s].comments_count || "", m = n;
                ...
                if (a.html(r), null != i) {
                    var g = t.parseJSON(i), f = a.parent(".swiper-container");
                    new Swiper(f, g)
    ...
    function A() {
        t(".swiper-container:not( .instafeed-wrapper )").each(function () {
            var e = t(this), a = e.attr("data-slider-options");
            if (null != a) {
                a = t.parseJSON(a);
    ...
    function B() {
        for (var e = 0; e < c.length; e++) {
            var t = c[e], a = t.$el.attr("data-slider-destroy");
