...
!function (t) {
    ...
    e.DEFAULTS = {
        ...
        return this.each(function () {
            var i = t(this), s = i.data("countTo"), n = "object" == typeof o ? o : {},
...
*/
!function (e) {
    var r = [], t = !1, n = !1, i = {interval: 250, force_process: !1}, a = e(window), o = [];
    ...
    e.expr.pseudos.appeared = e.expr.createPseudo(function (r) {
        return function (r) {
            ...
            var n = a.scrollLeft(), i = a.scrollTop(), o = t.offset(), p = o.left, f = o.top;
        ...
        appear: function (a, f) {
            ...
            u.force_process && setTimeout(p, u.interval), function (e) {
                r.push(e), o.push()
            }(a)
    ...
    e = function () {
        ...
        return o.prototype.defaults = {
            ...
            if (this.stopped = !1, this.boxes = function () {
                ...
                return o
            }.call(this), this.boxes.length) if (this.disabled()) this.resetStyle(); else for (n = 0, i = (o = this.boxes).length; i > n; n++) e = o[n], this.applyStyle(e, !0);
...
jQuery(document).ready(function (s) {
    var e, a, t = 2500, n = 3800, d = n - 3e3, r = 50, l = 150, o = 500, c = o + 800, h = 600, p = 1500;
    ...
    function f(s, i) {
        s.parents(".cd-headline").hasClass("type") ? (w(s.find("i").eq(0), s, !1, i), s.addClass("is-visible").removeClass("is-hidden")) : s.parents(".cd-headline").hasClass("clip") && s.parents(".cd-words-wrapper").animate({width: s.width() + 10}, h, function () {
            setTimeout(function () {
                u(s)
            }, p)
        })
    ...
    s(".cd-headline.letters").find("b").each(function () {
        var e = s(this), a = e.text().split(""), t = e.hasClass("is-visible");
        ...
        if (i.hasClass("loading-bar")) a = n, setTimeout(function () {
            ...
            var e = i.find(".cd-words-wrapper"), t = e.width() + 10;
            e.css("width", t)
        } else if (!i.hasClass("type")) {
            var r = i.find(".cd-words-wrapper b"), l = 0;
            r.each(function () {
                var i = s(this).width();
                i > l && (l = i)
