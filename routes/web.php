...
Route::get('/reward', 'LandingController@reward')->name('landing.reward');
Route::get('/selectedProductDetails', 'LandingController@selectedProductDetails')->name('landing.selectedProductDetails');
Route::get('/products-and-services', 'LandingController@productsAndServices')->name('landing.products-and-services');
